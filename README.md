Master: [![Build Status](https://exit.visualstudio.com/xFunc/_apis/build/status/sys27.xFunc?branchName=master)](https://exit.visualstudio.com/xFunc/_build/latest?definitionId=4&branchName=master) [![Coverage Status](https://coveralls.io/repos/github/sys27/xFunc/badge.svg?branch=master)](https://coveralls.io/github/sys27/xFunc?branch=master)  
Dev: [![Build Status](https://exit.visualstudio.com/xFunc/_apis/build/status/sys27.xFunc?branchName=dev)](https://exit.visualstudio.com/xFunc/_build/latest?definitionId=4&branchName=dev) [![Coverage Status](https://coveralls.io/repos/github/sys27/xFunc/badge.svg?branch=dev)](https://coveralls.io/github/sys27/xFunc?branch=dev)  
