...
namespace xFunc.Logics
{
    ...
    public class LogicParserException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogicParserException"/> class.
        /// </summary>
        public LogicParserException() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="LogicParserException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">A <see cref="String"/> that describes the error.</param>
        public LogicParserException(string message) : base(message) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="LogicParserException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">A <see cref="String"/> that describes the error.</param>
