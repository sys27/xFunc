...
namespace xFunc.Maths.Expressions.Angles
{
    ...
    /// </summary>
    public class AngleNumber : IExpression, IEquatable<AngleNumber>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (typeof(AngleNumber) != obj.GetType())
                return false;

            return Equals((AngleNumber)obj);
        }
        ...
        /// <summary>
        /// Clones this instance of the <see cref="AngleNumber"/> class.
        /// </summary>
        /// <returns>Returns the new instance of <see cref="IExpression"/> that is a clone of this instance.</returns>
        public IExpression Clone()
            => new AngleNumber(Value);
