...
namespace xFunc.Maths.Expressions.Angles
{
    ...
    public class ToRadian : UnaryExpression
    {
        ...
        /// <seealso cref="IExpression"/>
        internal ToRadian(IList<IExpression> arguments)
            : base(arguments)
        {
        }
        ...
        public override object Execute(ExpressionParameters parameters)
        {
            ...
            {
                double number => Angle.Radian(number),
                Angle angle => angle.ToRadian(),
        ...
        /// <summary>
        /// Clones this instance of the <see cref="ToRadian"/> class.
        /// </summary>
        /// <returns>Returns the new instance of <see cref="IExpression"/> that is a clone of this instance.</returns>
        public override IExpression Clone()
            => new ToRadian(Argument.Clone());
    }
}