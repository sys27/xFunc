...
namespace xFunc.Maths.Expressions.Hyperbolic
{
    ...
    public class Arcoth : HyperbolicExpression
    {
        ...
        internal Arcoth(IExpression[] arguments)
            : base(arguments)
        {
        }
        ...
        {
            return MathExtensions.Acoth(degree) / Math.PI * 180;
        }
        ...
        {
            return MathExtensions.Acoth(radian);
        }
        ...
        {
            return MathExtensions.Acoth(gradian) / Math.PI * 200;
        }
