...
namespace xFunc.Maths.Expressions.Hyperbolic
{
    ...
    public class Arcsch : HyperbolicExpression
    {
        ...
        internal Arcsch(IExpression[] arguments) : base(arguments)
        {
        }
        ...
        {
            return ComplexExtensions.Acsch(complex);
        }
        ...
        {
            return MathExtensions.Acsch(degree) / Math.PI * 180;
        }
        ...
        {
            return MathExtensions.Acsch(radian);
        }
        ...
        {
            return MathExtensions.Acsch(gradian) / Math.PI * 200;
        }
