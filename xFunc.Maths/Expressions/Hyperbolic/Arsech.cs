...
namespace xFunc.Maths.Expressions.Hyperbolic
{
    ...
    public class Arsech : HyperbolicExpression
    {
        ...
        public Arsech(IExpression expression) : base(expression)
        {
        }
        ...
        internal Arsech(IExpression[] arguments) : base(arguments)
        {
        }
        ...
        {
            return ComplexExtensions.Asech(complex);
        }
        ...
        {
            return MathExtensions.Asech(degree) / Math.PI * 180;
        }
        ...
        {
            return MathExtensions.Asech(radian);
        }
        ...
        {
            return new Arsech(m_argument.Clone());
        }
    }
}