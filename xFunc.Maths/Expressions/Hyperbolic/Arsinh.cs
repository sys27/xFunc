...
namespace xFunc.Maths.Expressions.Hyperbolic
{
    ...
    public class Arsinh : HyperbolicExpression
    {
        ...
        internal Arsinh(IList<IExpression> arguments)
            : base(arguments)
        {
        }
        ...
        protected override double ExecuteDegree(double degree) =>
            MathExtensions.Asinh(degree) / Math.PI * 180;
        ...
        protected override double ExecuteGradian(double gradian) =>
            MathExtensions.Asinh(gradian) / Math.PI * 200;
