...
namespace xFunc.Maths.Expressions.Hyperbolic
{
    ...
    public class Coth : HyperbolicExpression
    {
        ...
        public Coth(IExpression expression) : base(expression)
        {
        }
        ...
        internal Coth(IExpression[] arguments) : base(arguments)
        {
        }
        ...
        {
            return ComplexExtensions.Coth(complex);
        }
        ...
        {
            return MathExtensions.Coth(degree * Math.PI / 180);
        }
        ...
        {
            return MathExtensions.Coth(radian);
        }
        ...
        {
            return MathExtensions.Coth(gradian * Math.PI / 200);
        }
        ...
        {
            return new Coth(m_argument.Clone());
        }
    }
}