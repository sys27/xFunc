...
namespace xFunc.Maths.Expressions.Trigonometric
{
    ...
    public class Arccsc : TrigonometricExpression
    {
        ...
        public Arccsc(IExpression expression) : base(expression) { }
        ...
        {
            return MathExtentions.Acsc((double)m_argument.Execute(parameters)) / Math.PI * 180;
        }
        ...
        {
            return MathExtentions.Acsc((double)m_argument.Execute(parameters));
        }
        ...
        {
            return MathExtentions.Acsc((double)m_argument.Execute(parameters)) / Math.PI * 200;
        }
