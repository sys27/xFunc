...
namespace xFunc.Test.Expressions.Maths.Trigonometric
{
    ...
    public class ArccscTest
    {
        ...
        public void CalculateRadianTest()
        {
            ...
            Assert.AreEqual(MathExtentions.Acsc(1), exp.Calculate());
        }
        ...
        public void CalculateDegreeTest()
        {
            ...
            Assert.AreEqual(MathExtentions.Acsc(1) / Math.PI * 180, exp.Calculate());
        }
        ...
        public void CalculateGradianTest()
        {
            ...
            Assert.AreEqual(MathExtentions.Acsc(1) / Math.PI * 200, exp.Calculate());
        }
