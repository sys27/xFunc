...
namespace xFunc.Tests.Expressionss.Statistical
{
    ...
    public class VarpTest
    {
        ...
        {
            var exp = new Varp(new[] { new Number(4) }, 1);
        ...
        {
            var exp = new Varp(new[] { new Number(4), new Number(9) }, 2);
            var result = exp.Execute();
        ...
        {
            var exp = new Varp(new[] { new Number(9), new Number(2), new Number(4) }, 3);
        ...
        {
            var exp = new Varp(new[] { new Vector(new[] { new Number(2), new Number(4), new Number(9) }) }, 1);
            var result = (double)exp.Execute();
